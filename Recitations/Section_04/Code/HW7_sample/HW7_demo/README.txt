...
Then you can see the pid of hw7a is printed out. 
Then you run hw7b and input the pid of hw7a to interrupt hw7a. 
Then you can see the message that hw7a is interrupted. 
